...
JOB_APP = {
    ...
    "linkedin": "https://www.linkedin.com/tripathiraj981",
    "website": "",
    "github": "https://github.com/tripathiraj981",
    "twitter": "https://www.twitter.com/tripathiraj9801",
    "location": "Bangalore, India",
    "grad_month": '0',
    "grad_year": '2024',
    "university": "Chandigarh University" # if only o.O
}
...
def greenhouse(driver):
    ...
    # add graduation year
    try:
        driver.find_element_by_xpath("//select/option[text()='2024']").click()
    except NoSuchElementException:
        pass

    # add university
    try:
        driver.find_element_by_xpath("//select/option[contains(.,'Chandigarh University')]").click()
    except NoSuchElementException:
        pass

    # add degree
    try:
        driver.find_element_by_xpath("//select/option[contains(.,'Bachelor in Engineering')]").click()
    except NoSuchElementException:
        pass
